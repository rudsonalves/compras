...
mixin _$ProductDto implements DiagnosticableTreeMixin {
 ...
 String get name; String get description;@JsonKey(name: 'bar_code') String get barCode;@JsonKey(name: 'sale_by') SaleBy get saleBy;@JsonKey(name: 'category_id') String? get categoryId;@JsonKey(name: 'sub_category_id') String? get subCategoryId;@JsonKey(name: 'created_at') DateTime? get createdAt;@JsonKey(name: 'updated_at') DateTime? get updatedAt;
...
void debugFillProperties(DiagnosticPropertiesBuilder properties) {
  properties
    ...
    ..add(DiagnosticsProperty('name', name))..add(DiagnosticsProperty('description', description))..add(DiagnosticsProperty('barCode', barCode))..add(DiagnosticsProperty('saleBy', saleBy))..add(DiagnosticsProperty('categoryId', categoryId))..add(DiagnosticsProperty('subCategoryId', subCategoryId))..add(DiagnosticsProperty('createdAt', createdAt))..add(DiagnosticsProperty('updatedAt', updatedAt));
}
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,name,description,barCode,saleBy,categoryId,subCategoryId,createdAt,updatedAt);

@override
String toString({ DiagnosticLevel minLevel = DiagnosticLevel.info }) {
  return 'ProductDto(name: $name, description: $description, barCode: $barCode, saleBy: $saleBy, categoryId: $categoryId, subCategoryId: $subCategoryId, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
 String name, String description,@JsonKey(name: 'bar_code') String barCode,@JsonKey(name: 'sale_by') SaleBy saleBy,@JsonKey(name: 'category_id') String? categoryId,@JsonKey(name: 'sub_category_id') String? subCategoryId,@JsonKey(name: 'created_at') DateTime? createdAt,@JsonKey(name: 'updated_at') DateTime? updatedAt
});
...
/// Create a copy of ProductDto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? name = null,Object? description = null,Object? barCode = null,Object? saleBy = null,Object? categoryId = freezed,Object? subCategoryId = freezed,Object? createdAt = freezed,Object? updatedAt = freezed,}) {
...
class _ProductDto extends ProductDto with DiagnosticableTreeMixin {
  const _ProductDto({required this.name, required this.description, @JsonKey(name: 'bar_code') required this.barCode, @JsonKey(name: 'sale_by') this.saleBy = SaleBy.unit, @JsonKey(name: 'category_id') this.categoryId, @JsonKey(name: 'sub_category_id') this.subCategoryId, @JsonKey(name: 'created_at') this.createdAt, @JsonKey(name: 'updated_at') this.updatedAt}): super._();
...
/// Create a copy of ProductDto
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? name = null,Object? description = null,Object? barCode = null,Object? saleBy = null,Object? categoryId = freezed,Object? subCategoryId = freezed,Object? createdAt = freezed,Object? updatedAt = freezed,}) {
