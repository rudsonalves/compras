...
mixin _$CartItemDto {
 ...
 String get shoppingId;@JsonKey(name: 'product_id') String? get productId; String get name; String? get description;@JsonKey(name: 'bar_code') String? get barCode;@JsonKey(name: 'is_unit') bool get isUnit;@JsonKey(name: 'category_id') String? get categoryId;@JsonKey(name: 'category') String? get categoryName;@JsonKey(name: 'sub_category_id') String? get subCategoryId;@JsonKey(name: 'sub_category') String? get subCategoryName; int get price; int get quantity;
...
@override
int get hashCode => Object.hash(runtimeType,shoppingId,productId,name,description,barCode,isUnit,categoryId,categoryName,subCategoryId,subCategoryName,price,quantity);

@override
String toString() {
  return 'CartItemDto(shoppingId: $shoppingId, productId: $productId, name: $name, description: $description, barCode: $barCode, isUnit: $isUnit, categoryId: $categoryId, categoryName: $categoryName, subCategoryId: $subCategoryId, subCategoryName: $subCategoryName, price: $price, quantity: $quantity)';
}
...
@useResult
$Res call({
 String shoppingId,@JsonKey(name: 'product_id') String? productId, String name, String? description,@JsonKey(name: 'bar_code') String? barCode,@JsonKey(name: 'is_unit') bool isUnit,@JsonKey(name: 'category_id') String? categoryId,@JsonKey(name: 'category') String? categoryName,@JsonKey(name: 'sub_category_id') String? subCategoryId,@JsonKey(name: 'sub_category') String? subCategoryName, int price, int quantity
});
...
/// Create a copy of CartItemDto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? shoppingId = null,Object? productId = freezed,Object? name = null,Object? description = freezed,Object? barCode = freezed,Object? isUnit = null,Object? categoryId = freezed,Object? categoryName = freezed,Object? subCategoryId = freezed,Object? subCategoryName = freezed,Object? price = null,Object? quantity = null,}) {
...
class _CartItemDto implements CartItemDto {
  const _CartItemDto({required this.shoppingId, @JsonKey(name: 'product_id') this.productId, required this.name, this.description, @JsonKey(name: 'bar_code') this.barCode, @JsonKey(name: 'is_unit') this.isUnit = true, @JsonKey(name: 'category_id') this.categoryId, @JsonKey(name: 'category') this.categoryName, @JsonKey(name: 'sub_category_id') this.subCategoryId, @JsonKey(name: 'sub_category') this.subCategoryName, this.price = 0, this.quantity = 1});
