...
mixin _$LastPriceModel {
 ...
 String get id;@JsonKey(name: 'shopping_id') String get shoppingId;@JsonKey(name: 'product_id') String get productId;@JsonKey(name: 'last_unit_price') int get lastUnitPrice;@JsonKey(name: 'is_unit') bool get isUnit;@JsonKey(name: 'created_at') DateTime? get createdAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,shoppingId,productId,lastUnitPrice,isUnit,createdAt);

@override
String toString() {
  return 'LastPriceModel(id: $id, shoppingId: $shoppingId, productId: $productId, lastUnitPrice: $lastUnitPrice, isUnit: $isUnit, createdAt: $createdAt)';
}
...
@useResult
$Res call({
 String id,@JsonKey(name: 'shopping_id') String shoppingId,@JsonKey(name: 'product_id') String productId,@JsonKey(name: 'last_unit_price') int lastUnitPrice,@JsonKey(name: 'is_unit') bool isUnit,@JsonKey(name: 'created_at') DateTime? createdAt
});
...
/// Create a copy of LastPriceModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? shoppingId = null,Object? productId = null,Object? lastUnitPrice = null,Object? isUnit = null,Object? createdAt = freezed,}) {
...
as int,isUnit: null == isUnit ? _self.isUnit : isUnit // ignore: cast_nullable_to_non_nullable
...
class _LastPriceModel extends LastPriceModel {
  const _LastPriceModel({required this.id, @JsonKey(name: 'shopping_id') required this.shoppingId, @JsonKey(name: 'product_id') required this.productId, @JsonKey(name: 'last_unit_price') required this.lastUnitPrice, @JsonKey(name: 'is_unit') this.isUnit = true, @JsonKey(name: 'created_at') this.createdAt}): super._();
...
/// Create a copy of LastPriceModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? shoppingId = null,Object? productId = null,Object? lastUnitPrice = null,Object? isUnit = null,Object? createdAt = freezed,}) {
