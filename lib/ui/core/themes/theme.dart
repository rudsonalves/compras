...
class MaterialTheme {
  ...
  static ColorScheme lightScheme() {
    return const ColorScheme(
      ...
      onSecondaryContainer: Color(0xff573a70),
      ...
      secondaryFixedDim: Color(0xffdcb9f8),
  ...
  static ColorScheme lightMediumContrastScheme() {
    return const ColorScheme(
      ...
      secondary: Color(0xff45295e),
      onSecondary: Color(0xffffffff),
      secondaryContainer: Color(0xff7f6099),
      onSecondaryContainer: Color(0xffffffff),
      tertiary: Color(0xff003e39),
      onTertiary: Color(0xffffffff),
      ...
      secondaryFixed: Color(0xff7f6099),
      onSecondaryFixed: Color(0xffffffff),
      secondaryFixedDim: Color(0xff66487f),
  ...
  static ColorScheme lightHighContrastScheme() {
    return const ColorScheme(
      ...
      onPrimaryContainer: Color(0xffffffff),
      secondary: Color(0xff3b1f53),
      onSecondary: Color(0xffffffff),
      secondaryContainer: Color(0xff593d72),
      onSecondaryContainer: Color(0xffffffff),
      ...
      onPrimaryFixedVariant: Color(0xffffffff),
      secondaryFixed: Color(0xff593d72),
      onSecondaryFixed: Color(0xffffffff),
      secondaryFixedDim: Color(0xff42265a),
      onSecondaryFixedVariant: Color(0xffffffff),
  ...
  static ColorScheme darkMediumContrastScheme() {
    return const ColorScheme(
      ...
      onSecondary: Color(0xff34184c),
      secondaryContainer: Color(0xffa484bf),
      ...
      secondaryFixedDim: Color(0xffdcb9f8),
      onSecondaryFixedVariant: Color(0xff45295e),
      tertiaryFixed: Color(0xff9df2e7),
  ...
  static ColorScheme darkHighContrastScheme() {
    return const ColorScheme(
      ...
      secondaryContainer: Color(0xffd8b5f4),
      onSecondaryContainer: Color(0xff16002b),
      tertiary: Color(0xffaefff4),
      onTertiary: Color(0xff000000),
      tertiaryContainer: Color(0xff7dd1c7),
      ...
      secondaryFixedDim: Color(0xffdcb9f8),
      onSecondaryFixedVariant: Color(0xff1e0136),
      tertiaryFixed: Color(0xff9df2e7),
